...
namespace SisFact
{
    public class Acceso
    {
        ...
        public static int c_mesa;
        public static int c_piso;
        public static int c_cuenta;
        ...
        public void Ejecuta_trans(string sql)
        {
            comando = new SqlCommand(sql, conexion, Transaccion);
            comando.ExecuteNonQuery();
        }

        public void Lectura_trans(string sql)
        {
            comando = new SqlCommand(sql, conexion, Transaccion);
            dr = comando.ExecuteReader();
        }
